/**
 * \file testMpiHelloBoost.cpp
 * \brief A simple MPI helloworld using Boost' c++ API.
...
int main(int argc, char* argv[])
{
  ...
  if (world.rank() == 0) {
    ...
    reqs[0] = world.isend(1, 0, std::string("Hello"));
    ...
    reqs[0] = world.isend(0, 1, std::string("world"));
