...
/* copied from MPICH2 sources: $MPICH2_SRC/src/mpi/romio/test/file_info.c
   slightly modified to dump ROMIO values  */

/* 
 * build : mpicc -o dumpMpiInfo dumpMpiInfo.c
 *
 * run : mpirun -np 2 dumpMpiInfo -fname test.txt
 */
...
/* process 0 takes the file name as a command-line argument and 
   broadcasts it to other processes */
	...
	if (i >= argc) {
	    fprintf(stderr, "\n*#  Usage: dumpMpiInfo [-v] -fname filename\n\n");
