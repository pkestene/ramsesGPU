...
dnl Memo: AC_ARG_WITH(package, help-string, [if-given], [if-not-given])
  ...
  m4_ifdef([AM_SILENT_RULES], [
    AC_SUBST([moc_verbose],  ['$(moc_verbose_$(V))'])
	AC_SUBST([moc_verbose_], ['$(moc_verbose_$(AM_DEFAULT_VERBOSITY))'])
  ])
...
[Cannot find uic (User Interface Compiler) in your PATH. Try using --with-qt.])
  ...
  m4_ifdef([AM_SILENT_RULES], [
    AC_SUBST([uic_verbose],  ['$(uic_verbose_$(V))'])
	AC_SUBST([uic_verbose_], ['$(uic_verbose_$(AM_DEFAULT_VERBOSITY))'])
  ])
  ...
  m4_ifdef([AM_SILENT_RULES], [
    AC_SUBST([rcc_verbose],  ['$(rcc_verbose_$(V))'])
	AC_SUBST([rcc_verbose_], ['$(rcc_verbose_$(AM_DEFAULT_VERBOSITY))'])
  ])
